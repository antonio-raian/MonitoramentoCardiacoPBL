...
public class UpdateSensor extends java.awt.Dialog {
    ...
    public UpdateSensor(java.awt.Frame parent, boolean modal, String nick, String nome, String endNuvem, String portaNuvem, String endBorda, String portaBorda) throws IOException, ClassNotFoundException {
        ...
        this.nick = nick;
        this.nome = nome;
        this.endNuvem = endNuvem;
        this.portaNuvem = Integer.parseInt(portaNuvem);
        this.endBorda = endBorda;
    ...
    UpdateSensor(java.awt.Frame parent, boolean modal, String nick, String nome, String endereco, String porta) throws IOException, ClassNotFoundException {
        ...
        this.nick = nick;
        this.nome = nome;
        this.endNuvem = endereco;
        this.portaNuvem = Integer.parseInt(porta);
        this.endBorda = endNuvem;
        this.portaBorda = portaNuvem;
        conection();
        initComponents();        
        init();
    }
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtCoordX, javax.swing.GroupLayout.DEFAULT_SIZE, 34, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void conection() throws IOException{
        conect = new ConectionSensor(endBorda, portaBorda, endNuvem, portaNuvem);//Cria-se uma instancia para a classe de conexão
